...
hslider bounds(604, 150, 312, 33) channel("volStick") range(0.1, 5, 2,.5,.01) text("StickVolume") textColour("white")
hslider bounds(316, 256, 312, 33) channel("volSnare") range(0.1, 5, 2,.5,.01) text("SnareVolume") textColour("white")
...
kdrum       random      33, 46.999; randomly choose drum to strike
            schedkwhen  ktrigger, 0, 0, kdrum, 0, 0.1 ; strike a drum
  endin
