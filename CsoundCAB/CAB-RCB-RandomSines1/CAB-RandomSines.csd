...
hslider bounds(236, 6, 175, 50) channel("rate") range(.1, .3, .15, 1, 0.001) text("ReTrigRate") textColour("white")

hslider bounds(452, 6, 150, 50) channel("maxDur") range(.001, 1, .05, 1, 0.001) text("Max Dur") textColour("white")
hslider bounds(612, 6, 150, 50) channel("numInstrs") range(10, 200, 100, 1, 0.001) text("Num Voices") textColour("white")
...
gi3durLow = chnget:i("3durLow")+rnd(.12)
gi3durHi = chnget:i("3durHi")+rnd(.16)
gi3strtHi = chnget:i("maxDur")-gi3durHi

gi4frqLow = chnget:i("3frqLow")+rnd(4)
gi4frqHi = chnget:i("3frqHi")+rnd(44)
gi4durLow = chnget:i("3durLow")+rnd(.12)
gi4durHi = chnget:i("3durHi")+rnd(.18)
