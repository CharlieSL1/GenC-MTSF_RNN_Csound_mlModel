...
form caption("Sample Flooper1") size(650, 480), guiMode("queue") pluginId("rb86")
...
label  bounds(252, 164, 80, 20), text("Sample"), fontColour("white") 
combobox bounds(246, 190, 95, 28), channel("sound"),fontColour("White"),value(7),text("Bird","Bus","Fire","Ocean","Traffic","Whisper","Cabbage","Cereal","Kick1","Kick2","Kick3-TD","Tomek1","Tomek2","Dloop1")
...
Sfile1   = "./sounds/a-bird.aif"
Sfile2   = "./sounds/a-bus.aif"
Sfile3   = "./sounds/a-fire.wav"
Sfile4   = "./sounds/a-ocean.wav"
Sfile5   = "./sounds/a-traffic.aif"
Sfile6   = "./sounds/a-whisper.aif"
Sfile7   = "./sounds/cabbage.wav"
Sfile8   = "./sounds/cereal.wav"
Sfile9   = "./sounds/d-kick1.aif"
Sfile10  = "./sounds/d-kick2.wav"
Sfile11  = "./sounds/d-kick3-Temple.aif"
Sfile12  = "./sounds/d-Tomek1.wav"
Sfile13  = "./sounds/d-Tomek2.aif"
Sfile14  = "./sounds/drum1.aif"
...
giSmp11   ftgen  11, 0, 0, 1,  Sfile11, 0, 0, 0
giSmp12   ftgen  12, 0, 0, 1,  Sfile12, 0, 0, 0
giSmp13   ftgen  13, 0, 0, 1,  Sfile13, 0, 0, 0
giSmp14   ftgen  14, 0, 0, 1,  Sfile14, 0, 0, 0
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen11)), .001+(kLoopEnd * (iLen11)), 0.05, giSmp11, i(kLoopStrt) * (iLen11), int(iMode)

elseif kinput=12 then
iLen12  filelen Sfile12
if kLoopStrt > kLoopEnd then
kLoopStrt = kLoopEnd-.1
endif
if kLoopEnd < kLoopStrt then
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen12)), .001+(kLoopEnd * (iLen12)), 0.05, giSmp12, i(kLoopStrt) * (iLen12), int(iMode)

elseif kinput=13 then
iLen13  filelen Sfile13
if kLoopStrt > kLoopEnd then
kLoopStrt = kLoopEnd-.1
endif
if kLoopEnd < kLoopStrt then
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen13)), .001+(kLoopEnd * (iLen13)), 0.05, giSmp13, i(kLoopStrt) * (iLen13), int(iMode)

elseif kinput=14 then
iLen14  filelen Sfile14
if kLoopStrt > kLoopEnd then
kLoopStrt = kLoopEnd-.1
endif
if kLoopEnd < kLoopStrt then
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen14)), .001+(kLoopEnd * (iLen14)), 0.05, giSmp14, i(kLoopStrt) * (iLen14), int(iMode)
